  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden text-white">
      ...
      <header className="sticky top-0 z-20 border-b border-white/10 bg-slate-950/60 backdrop-blur-2xl">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-start gap-1.5 px-3 py-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-6 sm:py-4">
          ...
          <span className="max-w-full self-stretch rounded-full border border-cyan-400/25 bg-cyan-400/10 px-3 py-1 text-center text-[9px] font-semibold uppercase tracking-[0.16em] text-cyan-200 shadow-[0_0_30px_rgba(34,211,238,0.18)] sm:w-auto sm:self-auto sm:text-xs sm:tracking-[0.28em]">
            {headerBadge}
          </span>
        </div>
      </header>

      <main className={`relative z-10 mx-auto flex w-full max-w-6xl flex-1 px-2.5 py-2 sm:px-6 sm:py-8 ${mainClassName}`}>
