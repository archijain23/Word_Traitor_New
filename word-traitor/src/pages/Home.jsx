...
function Home() {
  ...
  return (
    <Layout>
      <div className="relative flex min-h-[calc(100vh-5.25rem)] items-center justify-center overflow-hidden sm:min-h-[calc(100vh-6rem)]">
        ...
        <div className="relative w-full max-w-5xl px-1 py-8 sm:px-4 sm:py-16">
          <div className="mb-10 text-center sm:mb-12">
            <div className="inline-flex max-w-full rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-cyan-100/85 shadow-[0_0_35px_rgba(34,211,238,0.2)] sm:px-4 sm:text-[11px] sm:tracking-[0.35em]">
              Social Deduction Night
            </div>
            <h1 className="mt-5 text-4xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-200 via-sky-300 to-fuchsia-400 drop-shadow-[0_0_25px_rgba(34,211,238,0.35)] sm:mt-6 sm:text-7xl">
              Word<span className="text-white">Traitor</span>
            </h1>
            <p className="mx-auto mt-4 max-w-2xl px-2 text-sm leading-6 text-zinc-300 sm:px-0 sm:text-base sm:leading-7">
          ...
          <div className="mt-8 grid gap-4 sm:mt-10 sm:gap-6 lg:grid-cols-2">
            <Card className="border-cyan-400/20 bg-slate-950/80 p-5 shadow-[0_22px_90px_-46px_rgba(34,211,238,0.45)] sm:p-8">
              <div className="mb-6">
                <div className="text-cyan-300 uppercase tracking-[0.3em] text-xs font-semibold mb-2">
                  Create Room
                </div>
                <h2 className="text-xl font-bold text-white sm:text-2xl">Start a new circle</h2>
            ...
            <Card className="border-fuchsia-400/20 bg-slate-950/80 p-5 shadow-[0_22px_90px_-46px_rgba(217,70,239,0.4)] sm:p-8">
              <div className="mb-6">
                <div className="text-fuchsia-300 uppercase tracking-[0.3em] text-xs font-semibold mb-2">
                  Join Room
                </div>
                <h2 className="text-xl font-bold text-white sm:text-2xl">Enter your code</h2>
                <p className="mt-3 text-sm leading-6 text-zinc-300/80">
          ...
          <div className="mt-10 text-center text-sm text-zinc-400 sm:mt-12">
            <span className="inline-flex max-w-full rounded-full border border-white/10 bg-white/5 px-4 py-2 text-center shadow-[0_0_35px_rgba(34,211,238,0.08)]">
